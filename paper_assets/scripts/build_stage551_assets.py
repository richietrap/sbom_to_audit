#!/usr/bin/env python3
"""Generate Stage 5.5.1 historical EPSS verification and ablation assets."""
...
def build(output_root: Path, destination: Path) -> dict[str, str]:
    ...
    metadata = {
        ...
        "source_run_ids": [
            "HIST-CVE-2024-3400-PUBLIC-STAGE551-CANDIDATE-001",
            "HIST-CVE-2024-3400-REF-STAGE551-CANDIDATE-001",
        ],
        "generation_script": "paper_assets/scripts/build_stage551_assets.py",
        ...
        "eligibility_note": (
            "Eligible for later evaluation freezing; authoritative online report supplied."
            if eligible
            else "Candidate only until required GitHub and Colab online verification gates pass."
        ),
    }
    manifest = destination / "data/stage551_asset_manifest.json"
